local Rayfield, Window, notifDuration, ScriptsTab, MiscTab = loadstring(game:HttpGet("https://raw.githubusercontent.com/TristyMP4/bloxxer/refs/heads/main/universal.lua"))()
