...
if game.PlaceId == "662417684" then
   return loadstring(game:HttpGet('https://github.com/TristyMP4/bloxxer/raw/refs/heads/main/luckyblockbattlegrounds.lua'))()
end
...
local Window = Rayfield:CreateWindow({
    ...
    KeySettings = {
       ...
       Key = "https://raw.githubusercontent.com/TristyMP4/bloxxer/refs/heads/main/keys.txt" -- List of keys that will be accepted by the system, can be RAW file links (pastebin, github etc) or simple strings ("hello","key22")
    }
 })
